...
parser.add_argument('--mocap-id', type=str, default='0702')
parser.add_argument('--range', type=int, default=(18, 24))
...
skt_bvh = os.path.expanduser('~/datasets/egopose/bvh/%s_%s.bvh' % (args.mocap_id, args.skt_id))
...
bvh_files = glob.glob(os.path.expanduser('~/datasets/egopose/bvh/%s_*.bvh' % args.mocap_id))
bvh_files.sort()
